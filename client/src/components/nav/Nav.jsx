...
import { BiGlobe, BiSolidSun, BiMoon } from "react-icons/bi"
...
const availableLanguages = [
    ...
    { id: 2, name: "Français", symbol: "fr" },
    { id: 3, name: "Polski", symbol: "pl" }
]
...
const Nav = memo(function Nav() {
    ...
    const handleLanguageChange = (e) => {
        ...
        if (selectedLanguage) {
            setCurrentLanguage(selectedLanguage.symbol)
                ...
                <nav className="nav nav__container">
                    ...
                    <div className="nav__settings">
                        <div className="nav__mode">
                            <BiSolidSun />
                            <input className="nav__checkbox-item" onClick={handleThemeChange} name="dark-mode" type="checkbox" aria-label={t(`darkInputAriaLabel`)} />
                            <BiMoon />
                        </div>
                                ...
                                {availableLanguages.map(language => (
                                    <div key={language.id} className={`nav__language-radios ${currentLanguage === language.symbol ? "nav__language-radios--active" : ""}`} >
                                        <input 
                                            ...
                                            aria-label={t(`langIconAriaLabel`)}
                                            type="radio" 
                                            name="language" 
